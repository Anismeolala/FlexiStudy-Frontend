      ...
      <SidebarContent>
        <Menu iconShape="circle">
          ...
          <Tooltip placement="right" title={collapsed ? "Developer Tools" : ""}>
            <MenuItem icon={<FaCode />} className="pro-menu-item" onClick={() => message.info('Chức năng đang được phát triển')}>
              Developer Tools
            </MenuItem>
          </Tooltip>
          <Tooltip placement="right" title={collapsed ? "Quản lý role & permission" : ""}>
            <MenuItem icon={<FaLock />} className="pro-menu-item" onClick={() => message.info('Chức năng đang được phát triển')}>
